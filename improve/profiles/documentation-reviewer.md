...
8. **DOCSTRINGS/DOCS THAT DON'T MATCH THE CODE**: Doc comments or external docs whose signatures, types, defaults, thrown errors, or described behavior no longer match the real code — including **timely comments** inside doc text that reference past/"old way" behavior. Validate every docstring against the actual implementation.
